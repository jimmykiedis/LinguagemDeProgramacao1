class Peca:
    ...
    def __str__(self):
        ...
        formato = '   {} {:<15} {} {:<12} {} {:<6} {} {}'
        peca_formatado = formato.format('|', self.nome, '|', self.categoria, '|', self.preco, '|', mão_obra_própria_str)
        return peca_formatado
    
class PeçaMecânica(Peca):
    def __init__(self, código, nome, categoria, preco, mão_obra_própria, tipo, prazo_garantia):
    ...
    def __str__(self):
        ...
        formato = '   {} {:<15} {} {:<12} {} {:<6} {} {:<8} {} {:>8} {}'
        peca_formatado = formato.format('|', self.nome, '|', self.categoria, '|', self.preco, '|', self.tipo, '|', self.prazo_garantia, '|', mão_obra_própria_str)
        return peca_formatado
...
class PeçaLataria(Peca):
    ...
    def __str__(self):
        ...
        formato = '   {} {:<15} {} {:<12} {} {:<6} {} {:<8} {} {:>8} {}'
        peca_formatado = formato.format('|', self.nome, '|', self.categoria, '|', self.preco, '|', self.tipo, '|', self.cor, '|', mão_obra_própria_str)
        return peca_formatado