...
def cadastrar_sinistros():
    ...
    sinistro.inserir_peça(Peça(código=11, nome='bandeja', categoria='OEM', preço=255, mecânico_próprio=False))
    sinistro.inserir_peça(Peça(código=12, nome='pivo', categoria='OEM', preço=255, mecânico_próprio=False))

    sinistro = Sinistro(numero='6', cliente='Scott', telefone='98988-1101')
    inserir_sinistro(sinistro)
    sinistro.inserir_peça(Peça(código=21, nome='amortecedor', categoria='Original', preço=310, mecânico_próprio=False))
    sinistro.inserir_peça(Peça(código=22, nome='kit batente', categoria='Original', preço=310, mecânico_próprio=False))

    sinistro = Sinistro(numero='11', cliente='Kennedy', telefone='96898-1000')
    inserir_sinistro(sinistro)
    sinistro.inserir_peça(Peça(código=31, nome='rolamento', categoria='Original', preço=180, mecânico_próprio=True))
    sinistro.inserir_peça(Peça(código=33, nome='cubo', categoria='Original', preço=180, mecânico_próprio=True))

    sinistro = Sinistro(numero='19', cliente='Chris', telefone='90898-0100')
    inserir_sinistro(sinistro)
    sinistro.inserir_peça(Peça(código=41, nome='terminal', categoria='Original', preço=90, mecânico_próprio=True))
    sinistro.inserir_peça(Peça(código=44, nome='barra axial', categoria='Original', preço=90, mecânico_próprio=True))

    sinistro = Sinistro(numero='98', cliente='Redfield', telefone='91681-1198')
    inserir_sinistro(sinistro)
    sinistro.inserir_peça(Peça(código=51, nome='disco freio', categoria='Genuína', preço=150, mecânico_próprio=True))
    sinistro.inserir_peça(Peça(código=55, nome='pastilha freio', categoria='Genuína', preço=150, mecânico_próprio=True))
